...
void AppTask::AppTaskMain(void * pvParameter)
{
    ...
    while(true)
    {
        ChipLogError(NotSpecified, "%ld , %s",count, "To be, or not to be, that is the question: Whether 'tis nobler in the mind to suffer the slings and arrows of outrageous fortune, or to take arms against a sea of troubles, and by opposing end them.");
        if (count++ == 200)
        {
            count = 0;
            osDelay(10000);
